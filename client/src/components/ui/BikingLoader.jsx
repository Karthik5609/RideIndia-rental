import WebGPULoaderBackdrop from "./WebGPULoaderBackdrop";

export default function BikingLoader() {
  return (
    <div className="loader-screen">
      <div className="truck-loader-frame" aria-label="Loading Ride India">
        <WebGPULoaderBackdrop />
      ...
      <p>Rider geared up. Rolling out...</p>
    </div>
  );
}
